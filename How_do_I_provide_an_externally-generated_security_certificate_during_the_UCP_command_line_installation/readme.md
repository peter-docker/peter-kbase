...
summary: "You are installing UCP via the command line as described in Install UCP for production from the Docker docs. To specify an externally-generated and signed certificate for the UCP controller during a command line installation, use the --external-server-cert option. ca.pem - This should have exactly one certificate, and that should be the root certificate authority for the whole chain. The next certificate should be the next certificate in the chain."
dateCreated: "Tue, 02 Aug 2016 23:26:08 GMT"
